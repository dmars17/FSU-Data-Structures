...
namespace cop4530 {
    ...
    public:
        ...
        void remove_if(PREDICATE pred); // remove all elements for which Predicate
        // pred returns true. pred can take in a function object

        void print(std::ostream& os, char ofc = ' ') const;    // print out all elements. ofc is deliminator
...
#include "List.hpp"     // include the implementation file here
}
#endif // end of namespace 4530
